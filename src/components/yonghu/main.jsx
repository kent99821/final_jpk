...
import { Carousel,Popover,message,Button} from 'antd';
  ...
  <div className="area5">
   ...
   <ul id='oul'>
        ...
        <div className='area6'>
          ...
          {/* <div  className='fw'>
          <Button ghost icon={<HomeFilled/>} type="dashed" ><a href='http://ehall.gdou.edu.cn/new/index.html'>服务大厅</a></Button>
          </div>
          <div className="gk">
          <Button ghost icon={<FileTextFilled/>} type="dashed" ><a href='https://www.gdou.edu.cn/kstd/xxgk1.htm'>信息公开</a></Button>
          </div>
          <div className="wx"><Button ghost icon={<WechatFilled/>} type="dashed" ><Popover content={content}>微信</Popover></Button></div> */}
        </div>
    </div>
        )
    }
